...
excerpt: Here are some general rules that I try to follow when coding in a SQL 
environment. There will always be exceptions, but you might want to keep these in mind when you're developing your own SQL scripts.
...
that I try to follow when coding in a SQL environment. These rules are 
derived from Joe Celko's **[SQL Programming 
